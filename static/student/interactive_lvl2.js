...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const pencilTypes = [
        ...
        { src: "/static/assets/Sorting/Sorting_Objects/crayons.jpg", width: "w-12", height: "h-12", type: "crayon" },
        { src: "/static/assets/Sorting/Sorting_Objects/eraser.jpg", width: "w-16", height: "h-16", type: "eraser" },
        { src: "/static/assets/Sorting/Sorting_Objects/notebook.png", width: "w-20", height: "h-20", type: "notebook" },
        { src: "/static/assets/Sorting/Sorting_Objects/pencil.jpg", width: "w-20", height: "h-20", type: "pencil" }
    ];

    // Set the number of pencils to 8
    const numberOfPencils = 20;
