...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const pencilTypes = [
        { src: "/static/assets/Sorting/Short_Medium_Long/short_pencil.png", width: "w-12", height: "h-10", type: "short" },
        { src: "/static/assets/Sorting/Short_Medium_Long/medium_pencil.png", width: "w-16", height: "h-16", type: "medium" },
        { src: "/static/assets/Sorting/Short_Medium_Long/long_pencil.png", width: "w-20", height: "h-30", type: "long" }
    ];

    // Set the number of pencils to 8
    const numberOfPencils = 10;
    ...
    $(".sorting-box").droppable({
        ...
        drop: function(event, ui) {
            ...
            if (boxType === pencilType) {
                ...
                console.log(`Incorrect! The ${pencilType} pencil was placed in the ${boxType} box.`);
            }
        }
    });
